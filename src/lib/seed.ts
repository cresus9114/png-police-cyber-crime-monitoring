    ...
    await Promise.all([
      db.suspect.create({
        data: {
          ...
          gender: "MALE",
          socialMediaProfiles: "Facebook: Michael Thompson (fake profile)",
          location: "Unknown (claims to be in Afghanistan)",
          physicalDescription: "Uses stolen photos of military personnel",
          notes: "Uses multiple fake military profiles across different platforms",
          cases: {
            connect: { id: sampleCases[0].id }
          }
        },
    ...
    await Promise.all([
      db.knowledgeArticle.create({
        data: {
          ...
          summary: "Step-by-step guide for romance scam investigations",
          tags: ["romance-scam", "investigation", "best-practices"],
          views: 45,
          rating: 4.8,
          relatedCases: ["CYBER-2024-001"],
        },
      }),
      db.knowledgeArticle.create({
        data: {
          ...
          summary: "Advisory on TikTok-based investment fraud trends",
